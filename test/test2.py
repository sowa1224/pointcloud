...
while Bot_x <= Final_x:
    ...
    extracted_point=np.append(extracted_point,selected_points)
...
"""""
# 抽出点が存在する場合のみ処理を実行
if extracted_point is not None:
    # 始点に一番近い点を探す
    ...
    # 始点と頂点の法線ベクトルを計算
    average_normal = (Bot_direction + Top_direction) / 2.0
...
# 抽出された点を表示
print("Extracted Points:", extracted_points)
